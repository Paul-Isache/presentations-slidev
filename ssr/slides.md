...
sequenceDiagram
  ...
  web_server-->>backend: get dashboard data
  backend-->>database: get dashboard data
  database-->>backend: return dashboard data
  backend-->>web_server: return dashboard data
